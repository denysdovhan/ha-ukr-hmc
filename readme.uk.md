...
Інтеграція зберігає глобальні прапорці метеорологічної та радіологічної уваги. Для пожежної, лавинної, метеорологічної та гідрологічної небезпеки використовуються деталізовані регіональні джерела, календарі та події Home Assistant.
...
| Загальні метеорологічний і радіаційний прапорці | Безпосередні глобальні прапорці постачальника без рівня, тексту або строку дії.                                                     |
...
endpoint-ів, часом останнього успіху, кількістю помилок і записів. Координати,
назви місць, ID станцій та інші приватні значення до нього не потрапляють.
